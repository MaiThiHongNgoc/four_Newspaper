...
const ProductDetails = () => {
    ...
    const [largeImage, setLargeImage] = useState("https://desero-store-demo.myshopify.com/cdn/shop/products/11.3.png?v=1656903842");
                ...
                <div className="productdetails-all">
                    <div className="productdetails-img">
                        ...
                        <div className="productdetails-imgmin">
                            <img 
                                className={activeImg === "https://desero-store-demo.myshopify.com/cdn/shop/products/12.3.png?v=1656903730" ? "productdetails-imgmin1 hover" : "productdetails-imgmin1"}
