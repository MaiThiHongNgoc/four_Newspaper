...
const ProductDetails = () => {
    ...
    const [largeImage, setLargeImage] = useState("https://bazaarvietnam.vn/wp-content/uploads/2021/07/nuoc-ep-can-tay-giam-beo-mat-4.jpg");
            ...
            <div className='producthome'>
                <div className='textproduct'>
                    <div className="productdetails-crumb">
                        <p>Home-<span>Celery juice</span></p>
                    </div>
                </div>
