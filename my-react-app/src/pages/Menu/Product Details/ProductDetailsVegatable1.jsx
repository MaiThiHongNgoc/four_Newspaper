...
const ProductDetails = () => {
    ...
    const [largeImage, setLargeImage] = useState("https://truejuice.vn/articles/wp-content/uploads/2021/03/nuoc-ep-ca-chua-truejuice.jpg");
            ...
            <div className='producthome'>
                <div className='textproduct'>
                    <div className="productdetails-crumb">
                        <p>Home-<span>Tomato juice</span></p>
                    </div>
                </div>
                <div className="productdetails-all">
                    <div className="productdetails-img">
                        ...
                        <div className="productdetails-imgmin">
                            <img 
                                className={activeImg === "https://truejuice.vn/articles/wp-content/uploads/2021/03/nuoc-ep-ca-chua-truejuice.jpg" ? "productdetails-imgmin1 hover" : "productdetails-imgmin1"}
                                src="https://truejuice.vn/articles/wp-content/uploads/2021/03/nuoc-ep-ca-chua-truejuice.jpg"
                                alt=""
                                onClick={() => handleImageClick("https://truejuice.vn/articles/wp-content/uploads/2021/03/nuoc-ep-ca-chua-truejuice.jpg")}
                            />
                            <img 
                                className={activeImg === "https://bazaarvietnam.vn/wp-content/uploads/2021/07/nuoc-ep-can-tay-giam-beo-mat-4.jpg" ? "productdetails-imgmin2 hover" : "productdetails-imgmin2"}
