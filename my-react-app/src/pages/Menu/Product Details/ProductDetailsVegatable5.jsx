...
const ProductDetails = () => {
    ...
    const [largeImage, setLargeImage] = useState("https://media.vov.vn/sites/default/files/styles/large/public/2023-03/sk2_9.jpgg");
            ...
            <div className='producthome'>
                <div className='textproduct'>
                    <div className="productdetails-crumb">
                        <p>Home-<span>Beetroot juice</span></p>
                    </div>
                </div>
                <div className="productdetails-all">
                    <div className="productdetails-img">
                        ...
                        <div className="productdetails-imgmin">
                            <img 
                                className={activeImg === "https://truejuice.vn/articles/wp-content/uploads/2021/06/nuoc-ep-cu-cai-trang-tri-ho-viem-hong-768x576.jpg" ? "productdetails-imgmin1 hover" : "productdetails-imgmin1"}
                            ...
                            />
                             <img 
                                className={activeImg === "https://cdn.phunuvagiadinh.vn/ctvseo_ladang/nuoc-ep-bi-do-kham-pha-tat-tan-tat-ve-cong-dung-va-cach-lam17.jpg" ? "productdetails-imgmin2 hover" : "productdetails-imgmin2"}
                                src="https://cdn.phunuvagiadinh.vn/ctvseo_ladang/nuoc-ep-bi-do-kham-pha-tat-tan-tat-ve-cong-dung-va-cach-lam17.jpg"
                                alt=""
                                onClick={() => handleImageClick("https://cdn.phunuvagiadinh.vn/ctvseo_ladang/nuoc-ep-bi-do-kham-pha-tat-tan-tat-ve-cong-dung-va-cach-lam17.jpg")}
                            />
