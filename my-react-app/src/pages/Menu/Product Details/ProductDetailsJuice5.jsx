...
const ProductDetails = () => {
    ...
    const [largeImage, setLargeImage] = useState("https://truejuice.vn/articles/wp-content/uploads/2021/04/nuoc-ep-le-dao-thai-doc-to.jpg");
                ...
                <div className="productdetails-all">
                    <div className="productdetails-img">
                        ...
                        <div className="productdetails-imgmin">
                            <img 
                                className={activeImg === "https://blog.ptlvina.com/wp-content/uploads/2021/02/nuoc-ep-nho-2.jpg" ? "productdetails-imgmin1 hover" : "productdetails-imgmin1"}
                            ...
                            />
                             <img 
                                className={activeImg === "https://truejuice.vn/articles/wp-content/uploads/2021/06/nuoc-ep-dua-luoi-mix-dua-truejuice.jpg" ? "productdetails-imgmin2 hover" : "productdetails-imgmin2"}
                                src="https://truejuice.vn/articles/wp-content/uploads/2021/06/nuoc-ep-dua-luoi-mix-dua-truejuice.jpg"
                                alt=""
                                onClick={() => handleImageClick("https://truejuice.vn/articles/wp-content/uploads/2021/06/nuoc-ep-dua-luoi-mix-dua-truejuice.jpg")}
                            />
