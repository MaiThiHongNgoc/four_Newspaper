...
const ProductDetails = () => {
    ...
    const [largeImage, setLargeImage] = useState("https://desero-store-demo.myshopify.com/cdn/shop/products/14.1.png?v=1656902680");
                ...
                <div className="productdetails-all">
                    <div className="productdetails-img">
                        ...
                        <div className="productdetails-imgmin">
                            <img 
                                className={activeImg === "https://desero-store-demo.myshopify.com/cdn/shop/products/10.1.png?v=1656903572" ? "productdetails-imgmin1 hover" : "productdetails-imgmin1"}
                            ...
                            />
                             <img 
                                className={activeImg === "https://desero-store-demo.myshopify.com/cdn/shop/products/14.1.png?v=1656902680" ? "productdetails-imgmin2 hover" : "productdetails-imgmin2"}
                                src="https://desero-store-demo.myshopify.com/cdn/shop/products/14.1.png?v=1656902680"
                                alt=""
                                onClick={() => handleImageClick("https://desero-store-demo.myshopify.com/cdn/shop/products/14.1.png?v=1656902680")}
                            />
